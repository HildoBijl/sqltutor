...
FROM employees;`}</SQLDisplay>
      <Par>This query retrieves all columns from the table <SQLDisplay inline>employees</SQLDisplay>. In SQL queries, superfluous white-space (linebreaks/tabs) is ignored, keywords are not case sensitive, and queries usually end with a semi-colon.</Par>
