  ...
  return <Page>
    ...
    <Section title="The plan of setting up a query">
      ...
      <List useNumbers items={[
        <>
          <Par>Determine the <Term>relation</Term> that you will need. For us that's the <RelationName>employees</RelationName> relation. We can write it down for our query as</Par>
          <RA style={{ marginTop: 8, marginBottom: 8 }}>employees</RA>
        </>,
        <>
          <Par>Apply <Term>filtering</Term> to get only the tuples that we need. This turns the query into</Par>
          <RA style={{ marginTop: 8, marginBottom: 8 }}>σ<sub>salary &gt; 200000</sub>(employees)</RA>
        </>,
        <>
          <Par>Apply <Term>projection</Term> to only extract the desired attributes. This gives the final result</Par>
