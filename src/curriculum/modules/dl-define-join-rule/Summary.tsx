...
export function Summary() {
  return <Page>
    <Section>
      ...
      <Info>Whenever the <Em>same variable name</Em> is used multiple times in a rule, Datalog requires it to have the <Em>same</Em> value at every occurrence. This is the trick we use to connect the predicates, completing the join. (An exception is the underscore, which does not count as a variable name: it represents an anonymous variable.)</Info>
    </Section>
  </Page>;
}
