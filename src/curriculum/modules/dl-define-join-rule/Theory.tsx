...
export function Theory() {
  return <Page>
    ...
    <Section title="Filter: add the join condition">
      ...
      <Par>In Datalog, if we ever use the <Em>same variable name</Em> in one rule, then this variable must have the <Em>same value</Em> everywhere it is used within this rule. We use this idea to shorten the above rule: we use the same variable name for the manager ID and the employee ID, denoting both as <IDL>mid</IDL>. (Any name will do, as long as it's equal.)</Par>
