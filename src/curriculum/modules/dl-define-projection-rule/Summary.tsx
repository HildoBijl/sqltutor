...
export function Summary() {
  return <Page>
    <Section>
      ...
      <Par>The notation can be shortened/simplified using <Term>anonymous variables</Term>: we turn any variable we don't use into an underscore <IDL>_</IDL>. The underscore here means "This variable can be anything; I won't use its value."</Par>
