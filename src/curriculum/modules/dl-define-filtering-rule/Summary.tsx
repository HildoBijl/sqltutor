...
export function Summary() {
  return <Page>
    <Section>
      ...
      <FigureExampleDLQuery query={<>employeeNamedBob(id, ln, p, e, a, c, hd, cs) :- employee(id, 'Bob', ln, p, e, a, c, hd, cs).</>} actualQuery="SELECT e_id, last_name, phone, email, address, city, hire_date, current_salary FROM employees WHERE first_name = 'Bob'" tableWidth={860} below />
