...
export function Summary() {
  return <Page>
    <Section>
      ...
      <Par>By following these three steps, we are guaranteed to end up with a dependency graph with layers. It can help us understand the Datalog script and evaluate the predicates within.</Par>
