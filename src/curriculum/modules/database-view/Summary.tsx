...
export function Summary() {
  return <Page>
    <Section>
      <Par>A <Term>view</Term> can be seen as a "recipe" for a new table, based on other already existing tables/views. First we have to define a view to the DBMS.</Par>
      ...
      <Par>When the DBMS receives a <Term>view definition</Term>, it only remembers this definition. It does not generate the table yet. Only when the view is requested, will the DBMS generate the table based on the instructions. If needed, this table can then be processed further, like any "normal" table.</Par>
